...
class TestDeconstruct(unittest.TestCase):
    """Conduct test_interflow for functions of deconstruct.py."""

    def test_deconstruct_dictionary(self):

        # create a sample level5 dictionary to test_interflow with
        level5_dict = {'region1_T1_T2_T3_T4_T5_to_S1_S2_S3_S4_S5_units': 100}

        # test_interflow that with the correct data input, the output is a dataframe
        output5 = deconstruct_dictionary(level5_dict)
        self.assertTrue(type(output5) == pd.DataFrame)

        # test_interflow that the output dataframe has the correct columns if a level 5 name is passed
        ...
        # test_interflow that the 'to' column is not in the output DataFrame
        ...
        # create a sample level4 dictionary to test_interflow with
        ...
        # test_interflow that the 'to' column is not in the output4 DataFrame
        ...
        # create a sample level3 dictionary to test_interflow with
        ...
        # test_interflow that the 'to' column is not in the output3 DataFrame
        ...
        # create a sample level2 dictionary to test_interflow with
        ...
        # test_interflow that the 'to' column is not in the output2 DataFrame
        ...
        # create a sample level1 dictionary to test_interflow with
        ...
        # test_interflow that the 'to' column is not in the output1 DataFrame
        ...
        # test_interflow that having too many underscore separated names in the key raises a ValueError
        ...
        # test_interflow that having too few underscore separated names in the key raises a ValueError
        with self.assertRaises(ValueError):
