...
def calc_wastewater_water_demand(data: pd.DataFrame, target_types: pd.DataFrame,
                                                 output='l5', regions=3):
                ...
                for x3 in split_dict[x1][x2]:
                    ...
                    for x4 in split_dict[x1][x2][x3]:
                        ...
                        for x5 in split_dict[x1][x2][x3][x4]:
                            ...
                            # if demand values available, demand = demand
                            ...
                            # if no wastewater demand values the demand equals estimated supply
                            else:
                                            ...
                                            for s4 in split_dict[x1][x2][x3][x4][x5][s1][s2][s3]:
                                                ...
                                                for s5 in split_dict[x1][x2][x3][x4][x5][s1][s2][s3][s4]:
                                                    ...
                                                    if l5_supply_name in ww_supply:
                                                        l5_demand_value = l5_demand_value + ww_supply[l5_supply_name]
